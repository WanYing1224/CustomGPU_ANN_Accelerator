...
// Project: NF2.1
// Description: Restored NetFPGA datapath with integrated Custom GPU ANN Accelerator
///////////////////////////////////////////////////////////////////////////////
`timescale 1ns/1ps
...
module user_data_path
  #(parameter DATA_WIDTH = 64,
   ...
   // ========================================================
   // DATAPATH BYPASS: Pass ethernet traffic straight through
   // so the network logic continues to function untouched.
   // ========================================================
   assign oq_in_data = ids_in_data;
   assign oq_in_ctrl = ids_in_ctrl;
   assign oq_in_wr   = ids_in_wr;
   assign ids_in_rdy = oq_in_rdy;

   // ========================================================
   // GPU WRAPPER: Sits exclusively on the Register Ring
   // ========================================================
   gpu_wrapper #(
      .DATA_WIDTH(DATA_WIDTH),
      .CTRL_WIDTH(CTRL_WIDTH),
